...
try:
    ...
    logger.warning('cannot import Image, '
                   'generating pdf covers for pdf uploads will not work: '
                   '%s', e)
...
try:
    ...
    logger.warning('cannot import PyPDF2, '
                   'extracting pdf metadata will not work: %s', e)
    use_pdf_meta = False
...
try:
    ...
    logger.warning('cannot import epub, '
                   'extracting epub metadata will not work: %s', e)
    use_epub_meta = False
...
try:
    ...
    logger.warning('cannot import fb2, '
                   'extracting fb2 metadata will not work: %s', e)
    use_fb2_meta = False
