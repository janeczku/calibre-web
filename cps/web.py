...
def category_list():
    ...
    return render_template('categories.html', showrandom=current_user.show_random_books(), entries=value, title=_(u"Category list"))
...
def category(name):
    ...
    if name != "all":
        ...
        name=_(u"all")
    return render_template('index.html', showrandom=current_user.show_random_books(), random=random, entries=entries, title=_(u"Category: %(nam)s",nam=name))
...
def register():
    ...
    return render_template('register.html', showrandom= 0, title="register")
