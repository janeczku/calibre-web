...
def get_sidebar_config(kwargs=None):
    ...
    sidebar = list()
    sidebar.append({"glyph": "bi-book", "text": _('Books'), "link": 'web.index', "id": "new",
                    "visibility": constants.SIDEBAR_RECENT, 'public': True, "page": "root",
                    "show_text": _('Show recent books'), "config_show":False})
    sidebar.append({"glyph": "bi-fire", "text": _('Hot Books'), "link": 'web.books_list', "id": "hot",
                    "visibility": constants.SIDEBAR_HOT, 'public': True, "page": "hot",
                    "show_text": _('Show Hot Books'), "config_show": True})
    if current_user.role_admin():
        sidebar.append({"glyph": "bi-download", "text": _('Downloaded Books'), "link": 'web.download_list',
        ...
        sidebar.append({"glyph": "bi-download", "text": _('Downloaded Books'), "link": 'web.books_list',
                        "id": "download", "visibility": constants.SIDEBAR_DOWNLOAD, 'public': (not current_user.is_anonymous),
                        "page": "download", "show_text": _('Show Downloaded Books'),
                        "config_show": content})
    sidebar.append(
        {"glyph": "bi-star-fill", "text": _('Top Rated Books'), "link": 'web.books_list', "id": "rated",
         "visibility": constants.SIDEBAR_BEST_RATED, 'public': True, "page": "rated",
         "show_text": _('Show Top Rated Books'), "config_show": True})
    sidebar.append({"glyph": "bi-eye", "text": _('Read Books'), "link": 'web.books_list', "id": "read",
                    "visibility": constants.SIDEBAR_READ_AND_UNREAD, 'public': (not current_user.is_anonymous),
                    "page": "read", "show_text": _('Show Read and Unread'), "config_show": content})
    sidebar.append(
        {"glyph": "bi-eye-slash", "text": _('Unread Books'), "link": 'web.books_list', "id": "unread",
         "visibility": constants.SIDEBAR_READ_AND_UNREAD, 'public': (not current_user.is_anonymous), "page": "unread",
         "show_text": _('Show unread'), "config_show": False})
    sidebar.append({"glyph": "bi-shuffle", "text": _('Discover'), "link": 'web.books_list', "id": "rand",
                    "visibility": constants.SIDEBAR_RANDOM, 'public': True, "page": "discover",
                    "show_text": _('Show Random Books'), "config_show": True})
    sidebar.append({"glyph": "bi-tags", "text": _('Categories'), "link": 'web.category_list', "id": "cat",
    ...
    sidebar.append({"glyph": "bi-bookmarks", "text": _('Series'), "link": 'web.series_list', "id": "serie",
    ...
    sidebar.append({"glyph": "bi-person", "text": _('Authors'), "link": 'web.author_list', "id": "author",
    ...
    sidebar.append(
        {"glyph": "bi-type", "text": _('Publishers'), "link": 'web.publisher_list', "id": "publisher",
    ...
    sidebar.append({"glyph": "bi-flag", "text": _('Languages'), "link": 'web.language_overview', "id": "lang",
    ...
    sidebar.append({"glyph": "bi-star", "text": _('Ratings'), "link": 'web.ratings_list', "id": "rate",
    ...
    sidebar.append({"glyph": "bi-file-earmark", "text": _('File formats'), "link": 'web.formats_list', "id": "format",
    ...
    sidebar.append(
        {"glyph": "bi-folder2-open", "text": _('Archived Books'), "link": 'web.books_list', "id": "archived",
         "visibility": constants.SIDEBAR_ARCHIVED, 'public': (not current_user.is_anonymous), "page": "archived",
         "show_text": _('Show Archived Books'), "config_show": content})
    if not simple:
        sidebar.append(
            {"glyph": "bi-list-ul", "text": _('Books List'), "link": 'web.books_table', "id": "list",
