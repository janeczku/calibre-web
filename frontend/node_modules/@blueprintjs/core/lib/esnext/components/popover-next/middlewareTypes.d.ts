 ...
 */
export type PopoverNextPlacement = "top" | "top-start" | "top-end" | "right" | "right-start" | "right-end" | "bottom" | "bottom-start" | "bottom-end" | "left" | "left-start" | "left-end";
/**
 ...
 */
export type PopoverNextPadding = number | Partial<{
    top: number;
    right: number;
    bottom: number;
    left: number;
