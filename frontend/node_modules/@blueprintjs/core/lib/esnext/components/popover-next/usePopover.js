...
export function usePopover({ autoUpdateOptions, disabled = false, isControlled = false, isHoverInteractionKind = false, isOpen = false, middleware, placement, positioningStrategy = "absolute", onOpenChange, } = {}) {
    ...
    const whileElementsMounted = useMemo(() => autoUpdateOptions != null
        ? (reference, floating, update) => autoUpdate(reference, floating, update, autoUpdateOptionsRef.current)
        : autoUpdate, 
