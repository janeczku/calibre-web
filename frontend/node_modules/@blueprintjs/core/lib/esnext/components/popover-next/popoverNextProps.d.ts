...
import type { DefaultPopoverTargetHTMLProps, PopoverClickTargetHandlers, PopoverHoverTargetHandlers } from "../popover/popoverSharedProps";
import type { PopupKind } from "../popover/popupKind";
import type { MiddlewareConfig, PopoverNextBoundary, PopoverNextPlacement, PopoverNextPositioningStrategy, PopoverNextRootBoundary } from "./middlewareTypes";
import { type usePopover } from "./usePopover";
export type { MiddlewareConfig, PopoverNextBoundary, PopoverNextPlacement, PopoverNextPositioningStrategy, PopoverNextRootBoundary, } from "./middlewareTypes";
/**
...
export interface PopoverNextProps<T extends DefaultPopoverTargetHTMLProps = DefaultPopoverTargetHTMLProps> {
     ...
     */
    renderTarget?: (props: PopoverRenderTargetProps & PopoverHoverTargetHandlers<T> & PopoverClickTargetHandlers<T>) => React.JSX.Element;
    /**
 ...
 */
export interface PopoverTargetProps extends Pick<PopoverNextProps, "children" | "disabled" | "fill" | "interactionKind" | "openOnTargetFocus" | "popupKind" | "renderTarget" | "targetProps" | "targetTagName"> {
    className?: string;
 ...
 */
export interface PopoverPopupProps extends Pick<PopoverNextProps, "arrow" | "animation" | "autoFocus" | "backdropProps" | "canEscapeKeyClose" | "captureDismiss" | "content" | "enforceFocus" | "hasBackdrop" | "inheritDarkTheme" | "interactionKind" | "lazy" | "matchTargetWidth" | "onClosed" | "onClosing" | "onOpened" | "onOpening" | "popoverClassName" | "popoverRef" | "portalClassName" | "portalContainer" | "shouldReturnFocusOnClose" | "transitionDuration" | "usePortal"> {
 ...
 */
export interface PopoverRenderTargetProps extends Pick<React.HTMLAttributes<HTMLElement>, "aria-haspopup" | "aria-expanded" | "className" | "tabIndex"> {
    /** Target ref. */
    ref: React.Ref<any>;
