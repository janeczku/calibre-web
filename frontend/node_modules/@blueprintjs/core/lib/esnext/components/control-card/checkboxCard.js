 ...
 */
export const CheckboxCard = forwardRef((props, ref) => {
    const { alignIndicator = Alignment.START, className, ...rest } = props;
    return (_jsx(ControlCard, { ...rest, alignIndicator: alignIndicator, className: classNames(className, Classes.CHECKBOX_CONTROL_CARD), controlKind: "checkbox", ref: ref }));
});
