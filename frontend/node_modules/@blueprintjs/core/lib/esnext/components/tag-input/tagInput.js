...
export class TagInput extends AbstractPureComponent {
    ...
    render() {
        ...
        const classes = classNames(Classes.INPUT, Classes.TAG_INPUT, {
            ...
            [Classes.FILL]: fill,
        }, Classes.intentClass(intent), Classes.sizeClass(size, { large }), className);
        ...
        _jsxs("div", { className: classes, onBlur: this.handleContainerBlur, onClick: this.handleContainerClick, children: [_jsx(Icon, { className: Classes.TAG_INPUT_ICON, icon: leftIcon, size: isLarge ? IconSize.LARGE : IconSize.STANDARD }), _jsxs("div", { className: Classes.TAG_INPUT_VALUES, children: [values.map(this.maybeRenderTag), this.props.children, autoResize ? _jsx(ResizableInput, { ...resolvedInputProps }) : _jsx("input", { ...resolvedInputProps })] }), this.props.rightElement] }));
    }
    ...
    maybeRenderTag = (tag, index) => {
        ...
        return (_jsx(Tag, { active: index === this.state.activeIndex, "data-tag-index": index, 
            // eslint-disable-next-line @typescript-eslint/no-deprecated
