...
export const Spinner = props => {
    ...
    return createElement(tagName, {
        ...
        role: "progressbar",
        ...htmlProps,
    }, createElement(tagName, { className: Classes.SPINNER_ANIMATION }, _jsxs("svg", { width: sizePx, height: sizePx, strokeWidth: strokeWidth.toFixed(2), viewBox: getViewBox(strokeWidth), children: [_jsx("path", { className: Classes.SPINNER_TRACK, d: SPINNER_TRACK }), _jsx("path", { className: Classes.SPINNER_HEAD, d: SPINNER_TRACK, pathLength: PATH_LENGTH, strokeDasharray: `${PATH_LENGTH} ${PATH_LENGTH}`, strokeDashoffset: strokeOffset })] })));
};
