 ...
 */
export function popoverPropsToNextProps(props) {
 ...
 */
export function popperBoundaryToNextBoundary(boundary) {
 ...
 */
export function popoverPlacementToNextPlacement(placement) {
    switch (placement) {
        case "auto":
        case "auto-start":
        case "auto-end":
