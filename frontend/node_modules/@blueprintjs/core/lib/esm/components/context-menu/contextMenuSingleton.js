...
export function showContextMenu(props, options = {}) {
    ...
    contextMenuState.unmount = render(_jsx(OverlaysProvider, { children: _jsx(UncontrolledContextMenuPopover, { ...props }) }), contextMenuState.element);
}
...
function UncontrolledContextMenuPopover({ onClose, ...props }) {
    ...
    return _jsx(ContextMenuPopover, { isOpen: isOpen, ...props, onClose: handleClose });
}
