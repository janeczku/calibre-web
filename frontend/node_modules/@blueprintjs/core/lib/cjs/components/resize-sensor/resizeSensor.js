 ...
 **/
class ResizeSensor extends common_1.AbstractPureComponent {
    static displayName = `${common_1.DISPLAYNAME_PREFIX}.ResizeSensor`;
    targetRef = this.props.targetRef ?? (0, react_1.createRef)();
    prevElement = undefined;
    observer;
    render() {
        const onlyChild = react_1.Children.only(this.props.children);
        ...
        return (0, react_1.cloneElement)(onlyChild, { ref: this.targetRef });
    }
    componentDidMount() {
