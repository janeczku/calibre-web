...
class Handle extends common_1.AbstractPureComponent {
    ...
    handleKeyDown = (event) => {
        ...
        const direction = common_1.Utils.getArrowKeyDirection(event, ["ArrowLeft", "ArrowDown"], ["ArrowRight", "ArrowUp"]);
    ...
    handleKeyUp = (event) => {
        if (common_1.Utils.isArrowKey(event)) {
    ...
    clamp(value) {
        return common_1.Utils.clamp(value, this.props.min, this.props.max);
    }
