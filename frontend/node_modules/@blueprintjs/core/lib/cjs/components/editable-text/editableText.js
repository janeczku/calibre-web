 ...
 */
class EditableText extends common_1.AbstractPureComponent {
    ...
    render() {
        ...
        return ((0, jsx_runtime_1.jsxs)("div", { className: classes, onFocus: this.handleFocus, tabIndex: tabIndex, ref: elementRef, children: [alwaysRenderInput || this.state.isEditing ? this.renderInput(value) : undefined, shouldHideContents ? undefined : ((0, jsx_runtime_1.jsx)("span", { ...spanProps, className: common_1.Classes.EDITABLE_TEXT_CONTENT, ref: this.refHandlers.content, style: contentStyle, children: hasValue ? value : this.props.placeholder }))] }));
    }
    componentDidMount() {
    ...
    renderInput(value) {
        ...
        return multiline ? ((0, jsx_runtime_1.jsx)("textarea", { ref: this.refHandlers.input, ...props, ...customInputAttributes })) : ((0, jsx_runtime_1.jsx)("input", { ref: this.refHandlers.input, type: type, ...props, ...customInputAttributes }));
    }
