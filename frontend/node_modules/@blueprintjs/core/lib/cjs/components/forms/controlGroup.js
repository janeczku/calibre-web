 ...
 */
exports.ControlGroup = (0, react_1.forwardRef)((props, ref) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { role: "group", ...htmlProps, ref: ref, className: rootClasses, children: children }));
});
exports.ControlGroup.displayName = `${props_1.DISPLAYNAME_PREFIX}.ControlGroup`;
