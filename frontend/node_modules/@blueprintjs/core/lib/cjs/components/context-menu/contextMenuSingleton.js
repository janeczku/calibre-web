...
function showContextMenu(props, options = {}) {
    ...
    contextMenuState.unmount = render((0, jsx_runtime_1.jsx)(overlaysProvider_1.OverlaysProvider, { children: (0, jsx_runtime_1.jsx)(UncontrolledContextMenuPopover, { ...props }) }), contextMenuState.element);
}
...
function UncontrolledContextMenuPopover({ onClose, ...props }) {
    ...
    return (0, jsx_runtime_1.jsx)(contextMenuPopover_1.ContextMenuPopover, { isOpen: isOpen, ...props, onClose: handleClose });
}
