...
exports.PopoverArrow = exports.TOOLTIP_ARROW_SVG_SIZE = exports.POPOVER_ARROW_SVG_SIZE = void 0;
...
exports.POPOVER_ARROW_SVG_SIZE = 30;
exports.TOOLTIP_ARROW_SVG_SIZE = 22;
...
function getArrowAngle(placement) {
    ...
    switch ((0, popperUtils_1.getBasePlacement)(placement)) {
        case "top":
            return -90;
        case "left":
            return 180;
...
function getArrowReferenceOffsetStyle(placement) {
    const offset = exports.POPOVER_ARROW_SVG_SIZE / 2 - ARROW_SPACING;
    switch ((0, popperUtils_1.getBasePlacement)(placement)) {
        case "top":
...
const PopoverArrow = ({ arrowProps: { ref, style }, placement }) => (
// data attribute allows popper.js to position the arrow
(0, jsx_runtime_1.jsx)("div", { "aria-hidden": true, className: common_1.Classes.POPOVER_ARROW, "data-popper-arrow": true, ref: ref, style: {
        ...style,
        ...getArrowReferenceOffsetStyle(placement),
    }, children: (0, jsx_runtime_1.jsxs)("svg", { viewBox: `0 0 ${exports.POPOVER_ARROW_SVG_SIZE} ${exports.POPOVER_ARROW_SVG_SIZE}`, style: { transform: `rotate(${getArrowAngle(placement)}deg)` }, children: [(0, jsx_runtime_1.jsx)("path", { className: common_1.Classes.POPOVER_ARROW + "-border", d: SVG_SHADOW_PATH }), (0, jsx_runtime_1.jsx)("path", { className: common_1.Classes.POPOVER_ARROW + "-fill", d: SVG_ARROW_PATH })] }) }));
exports.PopoverArrow = PopoverArrow;
exports.PopoverArrow.displayName = `${common_1.DISPLAYNAME_PREFIX}.PopoverArrow`;
