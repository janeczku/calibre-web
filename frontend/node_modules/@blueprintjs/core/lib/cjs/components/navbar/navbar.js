...
exports.Navbar.displayName = `${props_1.DISPLAYNAME_PREFIX}.Navbar`;
// compound components of Navbar
/** @deprecated Use `NavbarDivider` instead */
exports.Navbar.Divider = navbarDivider_1.NavbarDivider;
/** @deprecated Use `NavbarGroup` instead */
exports.Navbar.Group = navbarGroup_1.NavbarGroup;
/** @deprecated Use `NavbarHeading` instead */
exports.Navbar.Heading = navbarHeading_1.NavbarHeading;
