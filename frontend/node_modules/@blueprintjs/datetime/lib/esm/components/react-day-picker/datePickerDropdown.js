 ...
 */
export function DatePickerDropdown({ caption, children, ...props }) {
    ...
    const iconProps = useMemo(() => (props.name === "months" ? { style: { right: monthSelectRightOffset } } : {}), [props.name, monthSelectRightOffset]);
    return (_jsx("div", { ref: containerElement, children: _jsx(HTMLSelect, { iconProps: iconProps, minimal: true, ref: selectElement, ...props, children: children }) }));
}
