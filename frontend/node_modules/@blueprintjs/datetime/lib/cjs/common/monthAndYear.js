...
class MonthAndYear {
    ...
    getPreviousMonth() {
        const previousMonthDate = (0, dateUtils_1.getDatePreviousMonth)(this.date);
        return new MonthAndYear(previousMonthDate.getMonth(), previousMonthDate.getFullYear());
    }
    getNextMonth() {
        const nextMonthDate = (0, dateUtils_1.getDateNextMonth)(this.date);
