...
exports.lookupTimezoneOffset = lookupTimezoneOffset;
 ...
 */
function lookupTimezoneOffset(tz, date) {
    const offsetInMs = (0, date_fns_tz_1.getTimezoneOffset)(tz.ianaCode, date);
    if (isNaN(offsetInMs)) {
