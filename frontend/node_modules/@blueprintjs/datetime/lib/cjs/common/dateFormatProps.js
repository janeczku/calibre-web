...
function getFormattedDateString(date, props, ignoreRange = false) {
    if (date == null) {
        return "";
    }
    else if (!(0, dateUtils_1.isDateValid)(date)) {
        return props.invalidDateMessage;
    }
    else if (ignoreRange || (0, dateUtils_1.isDayInRange)(date, [props.minDate ?? null, props.maxDate ?? null])) {
