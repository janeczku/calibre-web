...
exports.MINIMAL_TIMEZONE_ITEMS = exports.TIMEZONE_ITEMS = exports.UTC_TIME = void 0;
/* eslint-disable sort-keys */
const timezoneOffsetUtils_1 = require("./timezoneOffsetUtils");
const utcWithoutOffset = { label: "UTC", ianaCode: "Etc/UTC" };
exports.UTC_TIME = (0, timezoneOffsetUtils_1.lookupTimezoneOffset)(utcWithoutOffset);
const timezonesWithoutOffset = [
    utcWithoutOffset,
...
const minimalTimezonesWithoutOffset = [
    utcWithoutOffset,
    { label: "Pago Pago", ianaCode: "Pacific/Pago_Pago" },
    { label: "Hawaii Time", ianaCode: "Pacific/Honolulu" },
    { label: "Marquesas", ianaCode: "Pacific/Marquesas" },
...
exports.TIMEZONE_ITEMS = timezonesWithoutOffset.map(tz => (0, timezoneOffsetUtils_1.lookupTimezoneOffset)(tz));
/** Minimal list of timezones */
exports.MINIMAL_TIMEZONE_ITEMS = minimalTimezonesWithoutOffset.map(tz => (0, timezoneOffsetUtils_1.lookupTimezoneOffset)(tz));
