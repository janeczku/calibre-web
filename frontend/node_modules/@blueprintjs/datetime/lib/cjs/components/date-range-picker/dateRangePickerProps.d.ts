...
export interface DateRangePickerProps extends Omit<DatePickerBaseProps, "dayPickerProps" | "locale" | "modifiers">, DateFnsLocaleProps, ReactDayPickerRangeProps, Props {
    /**
...
export type DateRangePickerDefaultProps = Required<Pick<DateRangePickerProps, "allowSingleDayRange" | "contiguousCalendarMonths" | "dayPickerProps" | "locale" | "maxDate" | "minDate" | "reverseMonthAndYearMenus" | "shortcuts" | "singleMonthOnly" | "timePickerProps">>;
export type DateRangePickerPropsWithDefaults = Omit<DateRangePickerProps, keyof DateRangePickerDefaultProps> & DateRangePickerDefaultProps;
